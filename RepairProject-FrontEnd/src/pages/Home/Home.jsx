...
export default function Home() {
  return (
    <>
      ...
      <div className="container flex flex-col justify-center items-center gap-9 mx-auto my-9">
      ...
      <div className="container flex flex-col justify-center items-center gap-5 mx-auto mt-16 relative lg:mt-24">
