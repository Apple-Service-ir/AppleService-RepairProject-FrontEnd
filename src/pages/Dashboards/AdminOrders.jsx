...
function AdminOrders() {
  ...
  function changeStatusToWorking(orderId) {
            ...
            <ul className="w-96 max-h-[80vh] overflow-y-scroll rounded-md">
              <li className='bg-white w-full h-12 rounded-md
                ...
                <button
                  ...
                  onClick={() => changeStatusToWorking(modal.order.id)}
                >
                ...
                <button className="bg-green-500 text-white w-9 h-9
                  flex justify-center items-center rounded-full
                ...
                <button className="bg-red-500 text-white w-9 h-9
                  flex justify-center items-center rounded-full
