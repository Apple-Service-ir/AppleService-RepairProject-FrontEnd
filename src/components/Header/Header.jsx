...
export function Header() {
  ...
  return (
    <>
      <div className={`${location.pathname === '/' && 'bg-blue-500'} w-screen p-5 z-50 duration-0`}>
        <div className='bg-blue-500 w-full flex justify-between items-center py-3 px-5 rounded-xl'>
          <div
